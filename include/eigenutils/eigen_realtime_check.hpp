...
// REALTIME_CHECKS is not defined, not need to do any checks on real-time code.
// Simply set ENTERING_REAL_TIME_CRITICAL_CODE and
// EXITING_REAL_TIME_CRITICAL_CODE to empty strings.
#define ENTERING_REAL_TIME_CRITICAL_CODE
#define EXITING_REAL_TIME_CRITICAL_CODE
